...
class C_SaveArgInit:
    ...
    def __reduce__(self):
        ...
        reduce = apply, (self.__class__, None, initKwargs), self.__getstate__()
...
class C_SaveDict_SaveArgInit_RestoreNothing:
...
class C_SaveDict_SaveArgInit_SetState:
...
class C_GetState_SaveArgInit_SetState:
