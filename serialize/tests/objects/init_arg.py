...
class C_InitArg_2():
    ...
    def __reduce__(self):
        initArgs = ('savedArg1',)
        reduce = self.__class__, initArgs , None # ou  {}
        log('        __reduce__ : ' + repr(reduce))
        return reduce
...
class C_InitArg_3():
    ...
    def __reduce__(self):
        initArgs = ('savedArg1',)
        reduce = self.__class__, initArgs , {}  
        log('        __reduce__ : ' + repr(reduce))
        return reduce
"""


class C_InitArg_SaveDict_RestoreNothing:
...
class C_InitArg_SaveDict_SetState:
...
class C_InitArg_GetState_SetState:
    # plus obligé de sauvegarder le state sous forme de dictionnaire !!!!
    def __init__(self, par1="defaut1", par2="defaut2"):
        log("        __init__(" + par1 + "," + par2 + ")")
        self.par2 = par2
        self._par1 = par1
