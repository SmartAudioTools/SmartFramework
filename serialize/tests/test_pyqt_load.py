...
obj.setCursor(
    instance(
        qtpy.QtGui.QCursor(),
        pos=qtpy.QtCore.QPoint(1569, 447),
...
obj.setPalette(
    instance(
        qtpy.QtGui.QPalette(),
        currentColorGroup=PyQt5.sip._unpickle_enum("PyQt5.QtGui", "ColorGroup", 0),
    )
)
...
obj.setSizePolicy(
    instance(
        ...
        # controlType=already_serialized,
        # horizontalPolicy=already_serialized,
        horizontalStretch=0,
