...
if API:
    ...
    def serializejson_QLayout(self):
        ...
        return type_str(self), None, None  # state
    ...
    #    return type(self), tuple(), getstate(self,split_dict_slots = False, keep=None, add= None, remove = None, filter_= True, properties=False, getters=False, sort_keys = True, remove_default_values = False)
    ...
    def serializejson_QPixmap(self):
        ...
        # return type_str(self), None, None #getstate(self,split_dict_slots = False, keep=None, add= None, remove=None, filter_= True, properties=False, getters=False, sort_keys = True, remove_default_values = False)
    ...
    #    return type_str(self), {"parent": self.parent()}, getstate(self,split_dict_slots = False, keep=None, add= None, remove = ["parent","minimumSize"], filter_= True, properties=False, getters=False, sort_keys = True, remove_default_values = False)
    ...
    setters[
        QtWidgets.QSpinBox
    ] = True  # get_properties(QtWidgets.QSpinBox) {'value' : 'setValue'}
    ...
    class Connection:
        ...
        def __serializejson__(self):
            ...
            return (
                ...
                {
                    "signal": Reference(
                        self.signal_object, signal_name_sig
                    ),  # #Reference(signal),
                    "slot": Reference(
