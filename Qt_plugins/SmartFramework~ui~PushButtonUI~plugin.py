...
icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "PushButtonUI.png")
if os.path.exists(icon_path):
    PushButtonUI.__icon__ = QtGui.QIcon(icon_path)
else:
    PushButtonUI.__icon__ = QtGui.QIcon()


class PushButtonUIPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(PushButtonUIPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.ui.PushButtonUI.PushButtonUI
        SmartFramework.ui.PushButtonUI.PushButtonUI = PushButtonUI
        instance = PushButtonUI(parent=parent)
        SmartFramework.ui.PushButtonUI.PushButtonUI = old_class
        return instance
    ...
    def icon(self):
        return PushButtonUI.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return PushButtonUI.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.ui.PushButtonUI"
