...
icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "FpsUI.png")
if os.path.exists(icon_path):
    FpsUI.__icon__ = QtGui.QIcon(icon_path)
else:
    FpsUI.__icon__ = QtGui.QIcon()


class FpsUIPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(FpsUIPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.video.FpsUI.FpsUI
        SmartFramework.video.FpsUI.FpsUI = FpsUI
        instance = FpsUI(parent=parent)
        SmartFramework.video.FpsUI.FpsUI = old_class
        return instance
    ...
    def icon(self):
        return FpsUI.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return FpsUI.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.video.FpsUI"
