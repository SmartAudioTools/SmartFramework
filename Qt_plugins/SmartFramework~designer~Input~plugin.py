...
icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "Input.png")
if os.path.exists(icon_path):
    Input.__icon__ = QtGui.QIcon(icon_path)
else:
    Input.__icon__ = QtGui.QIcon()


class InputPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(InputPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.designer.Input.Input
        SmartFramework.designer.Input.Input = Input
        instance = Input(parent=parent)
        SmartFramework.designer.Input.Input = old_class
        return instance
    ...
    def icon(self):
        return Input.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return Input.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.designer.Input"
