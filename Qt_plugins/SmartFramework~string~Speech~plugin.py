...
icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "Speech.png")
if os.path.exists(icon_path):
    Speech.__icon__ = QtGui.QIcon(icon_path)
else:
    Speech.__icon__ = QtGui.QIcon()


class SpeechPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(SpeechPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.string.Speech.Speech
        SmartFramework.string.Speech.Speech = Speech
        instance = Speech(parent=parent)
        SmartFramework.string.Speech.Speech = old_class
        return instance
    ...
    def includeFile(self):
        return "SmartFramework.string.Speech"
