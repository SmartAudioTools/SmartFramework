import os
import SmartFramework.midi.MidiNoteUnpack
...
MidiNoteUnpack = transformClassForQtDesigner(
    SmartFramework.midi.MidiNoteUnpack.MidiNoteUnpack
)
icon_path = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "MidiNoteUnpack.png"
)
if os.path.exists(icon_path):
    MidiNoteUnpack.__icon__ = QtGui.QIcon(icon_path)
else:
    MidiNoteUnpack.__icon__ = QtGui.QIcon()


class MidiNoteUnpackPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(MidiNoteUnpackPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.midi.MidiNoteUnpack.MidiNoteUnpack
        SmartFramework.midi.MidiNoteUnpack.MidiNoteUnpack = MidiNoteUnpack
        instance = MidiNoteUnpack(parent=parent)
        SmartFramework.midi.MidiNoteUnpack.MidiNoteUnpack = old_class
        return instance

    # This method returns the name of the custom widget class that is provided by this plugin.
    def name(self):
        return "MidiNoteUnpack"
    ...
    def icon(self):
        return MidiNoteUnpack.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return MidiNoteUnpack.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.midi.MidiNoteUnpack"
