...
Thread = transformClassForQtDesigner(SmartFramework.Thread.Thread)
icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "Thread.png")
if os.path.exists(icon_path):
    Thread.__icon__ = QtGui.QIcon(icon_path)
else:
    Thread.__icon__ = QtGui.QIcon()


class ThreadPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.Thread.Thread
        SmartFramework.Thread.Thread = Thread
        instance = Thread(parent=parent)
        SmartFramework.Thread.Thread = old_class
        return instance
