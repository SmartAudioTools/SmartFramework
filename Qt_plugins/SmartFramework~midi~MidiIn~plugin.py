import os
import SmartFramework.midi.MidiIn
...
MidiIn = transformClassForQtDesigner(SmartFramework.midi.MidiIn.MidiIn)
icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "MidiIn.png")
if os.path.exists(icon_path):
    MidiIn.__icon__ = QtGui.QIcon(icon_path)
else:
    MidiIn.__icon__ = QtGui.QIcon()


class MidiInPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(MidiInPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.midi.MidiIn.MidiIn
        SmartFramework.midi.MidiIn.MidiIn = MidiIn
        instance = MidiIn(parent=parent)
        SmartFramework.midi.MidiIn.MidiIn = old_class
        return instance
    ...
    def icon(self):
        return MidiIn.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return MidiIn.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.midi.MidiIn"
