import os
import SmartFramework.midi.MidiChannelSelect
...
MidiChannelSelect = transformClassForQtDesigner(
    SmartFramework.midi.MidiChannelSelect.MidiChannelSelect
)
icon_path = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "MidiChannelSelect.png"
)
if os.path.exists(icon_path):
    MidiChannelSelect.__icon__ = QtGui.QIcon(icon_path)
else:
    MidiChannelSelect.__icon__ = QtGui.QIcon()


class MidiChannelSelectPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(MidiChannelSelectPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.midi.MidiChannelSelect.MidiChannelSelect
        SmartFramework.midi.MidiChannelSelect.MidiChannelSelect = MidiChannelSelect
        instance = MidiChannelSelect(parent=parent)
        SmartFramework.midi.MidiChannelSelect.MidiChannelSelect = old_class
        return instance

    # This method returns the name of the custom widget class that is provided by this plugin.
    def name(self):
        return "MidiChannelSelect"
    ...
    def icon(self):
        return MidiChannelSelect.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return MidiChannelSelect.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.midi.MidiChannelSelect"
