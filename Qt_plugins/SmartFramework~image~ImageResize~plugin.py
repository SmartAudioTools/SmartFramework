import os
import SmartFramework.image.ImageResize
...
ImageResize = transformClassForQtDesigner(SmartFramework.image.ImageResize.ImageResize)
icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "ImageResize.png")
if os.path.exists(icon_path):
    ImageResize.__icon__ = QtGui.QIcon(icon_path)
else:
    ImageResize.__icon__ = QtGui.QIcon()


class ImageResizePlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(ImageResizePlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.image.ImageResize.ImageResize
        SmartFramework.image.ImageResize.ImageResize = ImageResize
        instance = ImageResize(parent=parent)
        SmartFramework.image.ImageResize.ImageResize = old_class
        return instance
    ...
    def icon(self):
        return ImageResize.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return ImageResize.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.image.ImageResize"
