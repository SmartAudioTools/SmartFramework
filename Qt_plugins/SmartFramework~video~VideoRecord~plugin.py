...
icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "VideoRecord.png")
if os.path.exists(icon_path):
    VideoRecord.__icon__ = QtGui.QIcon(icon_path)
else:
    VideoRecord.__icon__ = QtGui.QIcon()


class VideoRecordPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(VideoRecordPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.video.VideoRecord.VideoRecord
        SmartFramework.video.VideoRecord.VideoRecord = VideoRecord
        instance = VideoRecord(parent=parent)
        SmartFramework.video.VideoRecord.VideoRecord = old_class
        return instance
    ...
    def icon(self):
        return VideoRecord.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return VideoRecord.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.video.VideoRecord"
