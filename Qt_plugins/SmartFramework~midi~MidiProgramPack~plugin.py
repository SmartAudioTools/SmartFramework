import os
import SmartFramework.midi.MidiProgramPack
...
MidiProgramPack = transformClassForQtDesigner(
    SmartFramework.midi.MidiProgramPack.MidiProgramPack
)
icon_path = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "MidiProgramPack.png"
)
if os.path.exists(icon_path):
    MidiProgramPack.__icon__ = QtGui.QIcon(icon_path)
else:
    MidiProgramPack.__icon__ = QtGui.QIcon()


class MidiProgramPackPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(MidiProgramPackPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.midi.MidiProgramPack.MidiProgramPack
        SmartFramework.midi.MidiProgramPack.MidiProgramPack = MidiProgramPack
        instance = MidiProgramPack(parent=parent)
        SmartFramework.midi.MidiProgramPack.MidiProgramPack = old_class
        return instance

    # This method returns the name of the custom widget class that is provided by this plugin.
    def name(self):
        return "MidiProgramPack"
    ...
    def icon(self):
        return MidiProgramPack.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return MidiProgramPack.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.midi.MidiProgramPack"
