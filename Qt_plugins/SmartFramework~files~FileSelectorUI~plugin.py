...
icon_path = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "FileSelectorUI.png"
)
if os.path.exists(icon_path):
    FileSelectorUI.__icon__ = QtGui.QIcon(icon_path)
else:
    FileSelectorUI.__icon__ = QtGui.QIcon()


class FileSelectorUIPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(FileSelectorUIPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.files.FileSelectorUI.FileSelectorUI
        SmartFramework.files.FileSelectorUI.FileSelectorUI = FileSelectorUI
        instance = FileSelectorUI(parent=parent)
        SmartFramework.files.FileSelectorUI.FileSelectorUI = old_class
        return instance
    ...
    def icon(self):
        return FileSelectorUI.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return FileSelectorUI.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.files.FileSelectorUI"
