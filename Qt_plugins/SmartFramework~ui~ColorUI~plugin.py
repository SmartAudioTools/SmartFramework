import os
import SmartFramework.ui.ColorUI
...
ColorUI = transformClassForQtDesigner(SmartFramework.ui.ColorUI.ColorUI)
icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "ColorUI.png")
if os.path.exists(icon_path):
    ColorUI.__icon__ = QtGui.QIcon(icon_path)
else:
    ColorUI.__icon__ = QtGui.QIcon()


class ColorUIPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(ColorUIPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.ui.ColorUI.ColorUI
        SmartFramework.ui.ColorUI.ColorUI = ColorUI
        instance = ColorUI(parent=parent)
        SmartFramework.ui.ColorUI.ColorUI = old_class
        return instance
    ...
    def icon(self):
        return ColorUI.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return ColorUI.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.ui.ColorUI"
