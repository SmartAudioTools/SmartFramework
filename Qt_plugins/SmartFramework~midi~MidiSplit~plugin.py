import os
import SmartFramework.midi.MidiSplit
...
MidiSplit = transformClassForQtDesigner(SmartFramework.midi.MidiSplit.MidiSplit)
icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "MidiSplit.png")
if os.path.exists(icon_path):
    MidiSplit.__icon__ = QtGui.QIcon(icon_path)
else:
    MidiSplit.__icon__ = QtGui.QIcon()


class MidiSplitPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(MidiSplitPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.midi.MidiSplit.MidiSplit
        SmartFramework.midi.MidiSplit.MidiSplit = MidiSplit
        instance = MidiSplit(parent=parent)
        SmartFramework.midi.MidiSplit.MidiSplit = old_class
        return instance
    ...
    def icon(self):
        return MidiSplit.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return MidiSplit.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.midi.MidiSplit"
