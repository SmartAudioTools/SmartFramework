...
icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "LineEditUI.png")
if os.path.exists(icon_path):
    LineEditUI.__icon__ = QtGui.QIcon(icon_path)
else:
    LineEditUI.__icon__ = QtGui.QIcon()


class LineEditUIPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(LineEditUIPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.ui.LineEditUI.LineEditUI
        SmartFramework.ui.LineEditUI.LineEditUI = LineEditUI
        instance = LineEditUI(parent=parent)
        SmartFramework.ui.LineEditUI.LineEditUI = old_class
        return instance
    ...
    def icon(self):
        return LineEditUI.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return LineEditUI.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.ui.LineEditUI"
