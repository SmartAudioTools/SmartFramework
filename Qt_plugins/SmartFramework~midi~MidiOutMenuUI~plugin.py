import os
import SmartFramework.midi.MidiOutMenuUI
...
MidiOutMenuUI = transformClassForQtDesigner(
    SmartFramework.midi.MidiOutMenuUI.MidiOutMenuUI
)
icon_path = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "MidiOutMenuUI.png"
)
if os.path.exists(icon_path):
    MidiOutMenuUI.__icon__ = QtGui.QIcon(icon_path)
else:
    MidiOutMenuUI.__icon__ = QtGui.QIcon()


class MidiOutMenuUIPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(MidiOutMenuUIPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.midi.MidiOutMenuUI.MidiOutMenuUI
        SmartFramework.midi.MidiOutMenuUI.MidiOutMenuUI = MidiOutMenuUI
        instance = MidiOutMenuUI(parent=parent)
        SmartFramework.midi.MidiOutMenuUI.MidiOutMenuUI = old_class
        return instance

    # This method returns the name of the custom widget class that is provided by this plugin.
    def name(self):
        return "MidiOutMenuUI"
    ...
    def icon(self):
        return MidiOutMenuUI.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return MidiOutMenuUI.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.midi.MidiOutMenuUI"
