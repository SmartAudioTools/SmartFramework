import os
import SmartFramework.sync.SyncPresetUI
...
SyncPresetUI = transformClassForQtDesigner(
    SmartFramework.sync.SyncPresetUI.SyncPresetUI
)
icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "SyncPresetUI.png")
if os.path.exists(icon_path):
    SyncPresetUI.__icon__ = QtGui.QIcon(icon_path)
else:
    SyncPresetUI.__icon__ = QtGui.QIcon()


class SyncPresetUIPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(SyncPresetUIPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.sync.SyncPresetUI.SyncPresetUI
        SmartFramework.sync.SyncPresetUI.SyncPresetUI = SyncPresetUI
        instance = SyncPresetUI(parent=parent)
        SmartFramework.sync.SyncPresetUI.SyncPresetUI = old_class
        return instance
    ...
    def includeFile(self):
        return "SmartFramework.sync.SyncPresetUI"
