...
icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "TextEditorUI.png")
if os.path.exists(icon_path):
    TextEditorUI.__icon__ = QtGui.QIcon(icon_path)
else:
    TextEditorUI.__icon__ = QtGui.QIcon()


class TextEditorUIPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(TextEditorUIPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.ui.TextEditorUI.TextEditorUI
        SmartFramework.ui.TextEditorUI.TextEditorUI = TextEditorUI
        instance = TextEditorUI(parent=parent)
        SmartFramework.ui.TextEditorUI.TextEditorUI = old_class
        return instance
    ...
    def icon(self):
        return TextEditorUI.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return TextEditorUI.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.ui.TextEditorUI"
