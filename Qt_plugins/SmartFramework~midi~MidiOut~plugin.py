import os
import SmartFramework.midi.MidiOut
...
MidiOut = transformClassForQtDesigner(SmartFramework.midi.MidiOut.MidiOut)
icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "MidiOut.png")
if os.path.exists(icon_path):
    MidiOut.__icon__ = QtGui.QIcon(icon_path)
else:
    MidiOut.__icon__ = QtGui.QIcon()


class MidiOutPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(MidiOutPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.midi.MidiOut.MidiOut
        SmartFramework.midi.MidiOut.MidiOut = MidiOut
        instance = MidiOut(parent=parent)
        SmartFramework.midi.MidiOut.MidiOut = old_class
        return instance
    ...
    def icon(self):
        return MidiOut.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return MidiOut.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.midi.MidiOut"
