import os
import SmartFramework.midi.MidiNotePack
...
MidiNotePack = transformClassForQtDesigner(
    SmartFramework.midi.MidiNotePack.MidiNotePack
)
icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "MidiNotePack.png")
if os.path.exists(icon_path):
    MidiNotePack.__icon__ = QtGui.QIcon(icon_path)
else:
    MidiNotePack.__icon__ = QtGui.QIcon()


class MidiNotePackPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(MidiNotePackPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.midi.MidiNotePack.MidiNotePack
        SmartFramework.midi.MidiNotePack.MidiNotePack = MidiNotePack
        instance = MidiNotePack(parent=parent)
        SmartFramework.midi.MidiNotePack.MidiNotePack = old_class
        return instance
    ...
    def icon(self):
        return MidiNotePack.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return MidiNotePack.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.midi.MidiNotePack"
