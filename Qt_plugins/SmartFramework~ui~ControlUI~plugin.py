...
icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "ControlUI.png")
if os.path.exists(icon_path):
    ControlUI.__icon__ = QtGui.QIcon(icon_path)
else:
    ControlUI.__icon__ = QtGui.QIcon()


class ControlUIPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(ControlUIPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.ui.ControlUI.ControlUI
        SmartFramework.ui.ControlUI.ControlUI = ControlUI
        instance = ControlUI(parent=parent)
        SmartFramework.ui.ControlUI.ControlUI = old_class
        return instance
    ...
    def icon(self):
        return ControlUI.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return ControlUI.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.ui.ControlUI"
