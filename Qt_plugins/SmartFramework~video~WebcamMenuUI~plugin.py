import os
import SmartFramework.video.WebcamMenuUI
...
WebcamMenuUI = transformClassForQtDesigner(
    SmartFramework.video.WebcamMenuUI.WebcamMenuUI
)
icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "WebcamMenuUI.png")
if os.path.exists(icon_path):
    WebcamMenuUI.__icon__ = QtGui.QIcon(icon_path)
else:
    WebcamMenuUI.__icon__ = QtGui.QIcon()


class WebcamMenuUIPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(WebcamMenuUIPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.video.WebcamMenuUI.WebcamMenuUI
        SmartFramework.video.WebcamMenuUI.WebcamMenuUI = WebcamMenuUI
        instance = WebcamMenuUI(parent=parent)
        SmartFramework.video.WebcamMenuUI.WebcamMenuUI = old_class
        return instance
    ...
    def icon(self):
        return WebcamMenuUI.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return WebcamMenuUI.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.video.WebcamMenuUI"
