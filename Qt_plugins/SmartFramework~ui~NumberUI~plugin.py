import os
import SmartFramework.ui.NumberUI
...
NumberUI = transformClassForQtDesigner(SmartFramework.ui.NumberUI.NumberUI)
icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "NumberUI.png")
if os.path.exists(icon_path):
    NumberUI.__icon__ = QtGui.QIcon(icon_path)
else:
    NumberUI.__icon__ = QtGui.QIcon()


class NumberUIPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(NumberUIPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.ui.NumberUI.NumberUI
        SmartFramework.ui.NumberUI.NumberUI = NumberUI
        instance = NumberUI(parent=parent)
        SmartFramework.ui.NumberUI.NumberUI = old_class
        return instance
    ...
    def icon(self):
        return NumberUI.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return NumberUI.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.ui.NumberUI"
