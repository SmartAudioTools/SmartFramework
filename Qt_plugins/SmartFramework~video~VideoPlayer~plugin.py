import os
import SmartFramework.video.VideoPlayer
...
VideoPlayer = transformClassForQtDesigner(SmartFramework.video.VideoPlayer.VideoPlayer)
icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "VideoPlayer.png")
if os.path.exists(icon_path):
    VideoPlayer.__icon__ = QtGui.QIcon(icon_path)
else:
    VideoPlayer.__icon__ = QtGui.QIcon()


class VideoPlayerPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(VideoPlayerPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.video.VideoPlayer.VideoPlayer
        SmartFramework.video.VideoPlayer.VideoPlayer = VideoPlayer
        instance = VideoPlayer(parent=parent)
        SmartFramework.video.VideoPlayer.VideoPlayer = old_class
        return instance
    ...
    def icon(self):
        return VideoPlayer.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return VideoPlayer.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.video.VideoPlayer"
