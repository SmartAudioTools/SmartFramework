import os
import SmartFramework.midi.MidiControlPack
...
MidiControlPack = transformClassForQtDesigner(
    SmartFramework.midi.MidiControlPack.MidiControlPack
)
icon_path = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "MidiControlPack.png"
)
if os.path.exists(icon_path):
    MidiControlPack.__icon__ = QtGui.QIcon(icon_path)
else:
    MidiControlPack.__icon__ = QtGui.QIcon()


class MidiControlPackPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(MidiControlPackPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.midi.MidiControlPack.MidiControlPack
        SmartFramework.midi.MidiControlPack.MidiControlPack = MidiControlPack
        instance = MidiControlPack(parent=parent)
        SmartFramework.midi.MidiControlPack.MidiControlPack = old_class
        return instance

    # This method returns the name of the custom widget class that is provided by this plugin.
    def name(self):
        return "MidiControlPack"
    ...
    def icon(self):
        return MidiControlPack.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return MidiControlPack.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.midi.MidiControlPack"
