...
icon_path = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "CurveSelectorUI.png"
)
if os.path.exists(icon_path):
    CurveSelectorUI.__icon__ = QtGui.QIcon(icon_path)
else:
    CurveSelectorUI.__icon__ = QtGui.QIcon()


class CurveSelectorUIPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(CurveSelectorUIPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.plot.CurveSelectorUI.CurveSelectorUI
        SmartFramework.plot.CurveSelectorUI.CurveSelectorUI = CurveSelectorUI
        instance = CurveSelectorUI(parent=parent)
        SmartFramework.plot.CurveSelectorUI.CurveSelectorUI = old_class
        return instance

    # This method returns the name of the custom widget class that is provided by this plugin.
    def name(self):
        return "CurveSelectorUI"
    ...
    def icon(self):
        return CurveSelectorUI.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return CurveSelectorUI.__doc__
