...
icon_path = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "CyclicalComboBoxUI.png"
)
if os.path.exists(icon_path):
    CyclicalComboBoxUI.__icon__ = QtGui.QIcon(icon_path)
else:
    CyclicalComboBoxUI.__icon__ = QtGui.QIcon()


class CyclicalComboBoxUIPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(CyclicalComboBoxUIPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.ui.CyclicalComboBoxUI.CyclicalComboBoxUI
        SmartFramework.ui.CyclicalComboBoxUI.CyclicalComboBoxUI = CyclicalComboBoxUI
        instance = CyclicalComboBoxUI(parent=parent)
        SmartFramework.ui.CyclicalComboBoxUI.CyclicalComboBoxUI = old_class
        return instance

    # This method returns the name of the custom widget class that is provided by this plugin.
    def name(self):
        return "CyclicalComboBoxUI"
    ...
    def icon(self):
        return CyclicalComboBoxUI.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return CyclicalComboBoxUI.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.ui.CyclicalComboBoxUI"
