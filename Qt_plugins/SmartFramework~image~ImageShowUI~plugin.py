...
icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "ImageShowUI.png")
if os.path.exists(icon_path):
    ImageShowUI.__icon__ = QtGui.QIcon(icon_path)
else:
    ImageShowUI.__icon__ = QtGui.QIcon()


class ImageShowUIPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(ImageShowUIPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.image.ImageShowUI.ImageShowUI
        SmartFramework.image.ImageShowUI.ImageShowUI = ImageShowUI
        instance = ImageShowUI(parent=parent)
        SmartFramework.image.ImageShowUI.ImageShowUI = old_class
        return instance
    ...
    def icon(self):
        return ImageShowUI.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return ImageShowUI.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.image.ImageShowUI"
