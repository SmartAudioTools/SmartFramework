...
icon_path = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "TestGranularityUI.png"
)
if os.path.exists(icon_path):
    TestGranularityUI.__icon__ = QtGui.QIcon(icon_path)
else:
    TestGranularityUI.__icon__ = QtGui.QIcon()


class TestGranularityUIPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(TestGranularityUIPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.time.TestGranularityUI.TestGranularityUI
        SmartFramework.time.TestGranularityUI.TestGranularityUI = TestGranularityUI
        instance = TestGranularityUI(parent=parent)
        SmartFramework.time.TestGranularityUI.TestGranularityUI = old_class
        return instance

    # This method returns the name of the custom widget class that is provided by this plugin.
    def name(self):
        return "TestGranularityUI"
    ...
    def icon(self):
        return TestGranularityUI.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return TestGranularityUI.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.time.TestGranularityUI"
