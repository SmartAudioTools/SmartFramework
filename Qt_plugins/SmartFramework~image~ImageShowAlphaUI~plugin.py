import os
import SmartFramework.image.ImageShowAlphaUI
...
ImageShowAlphaUI = transformClassForQtDesigner(
    SmartFramework.image.ImageShowAlphaUI.ImageShowAlphaUI
)
icon_path = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "ImageShowAlphaUI.png"
)
if os.path.exists(icon_path):
    ImageShowAlphaUI.__icon__ = QtGui.QIcon(icon_path)
else:
    ImageShowAlphaUI.__icon__ = QtGui.QIcon()


class ImageShowAlphaUIPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(ImageShowAlphaUIPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.image.ImageShowAlphaUI.ImageShowAlphaUI
        SmartFramework.image.ImageShowAlphaUI.ImageShowAlphaUI = ImageShowAlphaUI
        instance = ImageShowAlphaUI(parent=parent)
        SmartFramework.image.ImageShowAlphaUI.ImageShowAlphaUI = old_class
        return instance

    # This method returns the name of the custom widget class that is provided by this plugin.
    def name(self):
        return "ImageShowAlphaUI"
    ...
    def icon(self):
        return ImageShowAlphaUI.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return ImageShowAlphaUI.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.image.ImageShowAlphaUI"
