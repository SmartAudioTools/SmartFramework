...
import SmartFramework.ui.BrowserUI
import os

BrowserUI = transformClassForQtDesigner(SmartFramework.ui.BrowserUI.BrowserUI)
BrowserUI.__icon__ = QtGui.QIcon(
    os.path.join(os.path.dirname(os.path.abspath(__file__)), "BrowserUI.png")
)


class BrowserUIPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):

    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(BrowserUIPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.ui.BrowserUI.BrowserUI
        SmartFramework.ui.BrowserUI.BrowserUI = BrowserUI
        instance = BrowserUI(parent=parent)
        SmartFramework.ui.BrowserUI.BrowserUI = old_class
        return instance
    ...
    def icon(self):
        return BrowserUI.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return BrowserUI.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.ui.BrowserUI"
