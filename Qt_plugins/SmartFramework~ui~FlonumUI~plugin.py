...
icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "FlonumUI.png")
if os.path.exists(icon_path):
    FlonumUI.__icon__ = QtGui.QIcon(icon_path)
else:
    FlonumUI.__icon__ = QtGui.QIcon()


class FlonumUIPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(FlonumUIPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.ui.FlonumUI.FlonumUI
        SmartFramework.ui.FlonumUI.FlonumUI = FlonumUI
        instance = FlonumUI(parent=parent)
        SmartFramework.ui.FlonumUI.FlonumUI = old_class
        return instance
    ...
    def icon(self):
        return FlonumUI.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return FlonumUI.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.ui.FlonumUI"
