...
icon_path = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "SerializePresetUI.png"
)
if os.path.exists(icon_path):
    SerializePresetUI.__icon__ = QtGui.QIcon(icon_path)
else:
    SerializePresetUI.__icon__ = QtGui.QIcon()


class SerializePresetUIPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(SerializePresetUIPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.serialize.SerializePresetUI.SerializePresetUI
        SmartFramework.serialize.SerializePresetUI.SerializePresetUI = SerializePresetUI
        instance = SerializePresetUI(parent=parent)
        SmartFramework.serialize.SerializePresetUI.SerializePresetUI = old_class
        return instance

    # This method returns the name of the custom widget class that is provided by this plugin.
    def name(self):
        return "SerializePresetUI"

    # Returns the name of the group in Qt Designer's widget box that this widget belongs to.
    def group(self):
        return "SmartFramework.serialize"

    # Returns the icon used to represent the custom widget in Qt Designer's widget box.
    def icon(self):
        return SerializePresetUI.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return SerializePresetUI.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.serialize.SerializePresetUI"
