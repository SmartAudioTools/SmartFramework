...
icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "MessageUI.png")
if os.path.exists(icon_path):
    MessageUI.__icon__ = QtGui.QIcon(icon_path)
else:
    MessageUI.__icon__ = QtGui.QIcon()


class MessageUIPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(MessageUIPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.ui.MessageUI.MessageUI
        SmartFramework.ui.MessageUI.MessageUI = MessageUI
        instance = MessageUI(parent=parent)
        SmartFramework.ui.MessageUI.MessageUI = old_class
        return instance
    ...
    def icon(self):
        return MessageUI.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return MessageUI.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.ui.MessageUI"
