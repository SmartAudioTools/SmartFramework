...
icon_path = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "ClickableQLabelUI.png"
)
if os.path.exists(icon_path):
    ClickableQLabelUI.__icon__ = QtGui.QIcon(icon_path)
else:
    ClickableQLabelUI.__icon__ = QtGui.QIcon()


class ClickableQLabelUIPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(ClickableQLabelUIPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.ui.ClickableQLabelUI.ClickableQLabelUI
        SmartFramework.ui.ClickableQLabelUI.ClickableQLabelUI = ClickableQLabelUI
        instance = ClickableQLabelUI(parent=parent)
        SmartFramework.ui.ClickableQLabelUI.ClickableQLabelUI = old_class
        return instance

    # This method returns the name of the custom widget class that is provided by this plugin.
    def name(self):
        return "ClickableQLabelUI"
    ...
    def icon(self):
        return ClickableQLabelUI.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return ClickableQLabelUI.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.ui.ClickableQLabelUI"
