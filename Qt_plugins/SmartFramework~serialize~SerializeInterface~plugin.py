...
icon_path = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "SerializeInterface.png"
)
if os.path.exists(icon_path):
    SerializeInterface.__icon__ = QtGui.QIcon(icon_path)
else:
    SerializeInterface.__icon__ = QtGui.QIcon()


class SerializeInterfacePlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(SerializeInterfacePlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.serialize.SerializeInterface.SerializeInterface
        SmartFramework.serialize.SerializeInterface.SerializeInterface = (
            SerializeInterface
        )
        instance = SerializeInterface(parent=parent)
        SmartFramework.serialize.SerializeInterface.SerializeInterface = old_class
        return instance
    ...
    def icon(self):
        return SerializeInterface.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return SerializeInterface.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.serialize.SerializeInterface"
