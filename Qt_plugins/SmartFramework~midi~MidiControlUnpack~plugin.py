import os
import SmartFramework.midi.MidiControlUnpack
...
MidiControlUnpack = transformClassForQtDesigner(
    SmartFramework.midi.MidiControlUnpack.MidiControlUnpack
)
icon_path = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "MidiControlUnpack.png"
)
if os.path.exists(icon_path):
    MidiControlUnpack.__icon__ = QtGui.QIcon(icon_path)
else:
    MidiControlUnpack.__icon__ = QtGui.QIcon()


class MidiControlUnpackPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(MidiControlUnpackPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.midi.MidiControlUnpack.MidiControlUnpack
        SmartFramework.midi.MidiControlUnpack.MidiControlUnpack = MidiControlUnpack
        instance = MidiControlUnpack(parent=parent)
        SmartFramework.midi.MidiControlUnpack.MidiControlUnpack = old_class
        return instance

    # This method returns the name of the custom widget class that is provided by this plugin.
    def name(self):
        return "MidiControlUnpack"
    ...
    def icon(self):
        return MidiControlUnpack.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return MidiControlUnpack.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.midi.MidiControlUnpack"
