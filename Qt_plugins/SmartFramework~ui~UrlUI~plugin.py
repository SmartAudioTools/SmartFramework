...
icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "UrlUI.png")
if os.path.exists(icon_path):
    UrlUI.__icon__ = QtGui.QIcon(icon_path)
else:
    UrlUI.__icon__ = QtGui.QIcon()


class UrlUIPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(UrlUIPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.ui.UrlUI.UrlUI
        SmartFramework.ui.UrlUI.UrlUI = UrlUI
        instance = UrlUI(parent=parent)
        SmartFramework.ui.UrlUI.UrlUI = old_class
        return instance
    ...
    def icon(self):
        return UrlUI.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return UrlUI.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.ui.UrlUI"
