...
icon_path = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "IntervalMeanUI.png"
)
if os.path.exists(icon_path):
    IntervalMeanUI.__icon__ = QtGui.QIcon(icon_path)
else:
    IntervalMeanUI.__icon__ = QtGui.QIcon()


class IntervalMeanUIPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(IntervalMeanUIPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.video.IntervalMeanUI.IntervalMeanUI
        SmartFramework.video.IntervalMeanUI.IntervalMeanUI = IntervalMeanUI
        instance = IntervalMeanUI(parent=parent)
        SmartFramework.video.IntervalMeanUI.IntervalMeanUI = old_class
        return instance

    # This method returns the name of the custom widget class that is provided by this plugin.
    def name(self):
        return "IntervalMeanUI"
    ...
    def icon(self):
        return IntervalMeanUI.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return IntervalMeanUI.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.video.IntervalMeanUI"
