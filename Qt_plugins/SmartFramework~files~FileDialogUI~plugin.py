...
icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "FileDialogUI.png")
if os.path.exists(icon_path):
    FileDialogUI.__icon__ = QtGui.QIcon(icon_path)
else:
    FileDialogUI.__icon__ = QtGui.QIcon()


class FileDialogUIPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(FileDialogUIPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.files.FileDialogUI.FileDialogUI
        SmartFramework.files.FileDialogUI.FileDialogUI = FileDialogUI
        instance = FileDialogUI(parent=parent)
        SmartFramework.files.FileDialogUI.FileDialogUI = old_class
        return instance
    ...
    def icon(self):
        return FileDialogUI.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return FileDialogUI.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.files.FileDialogUI"
