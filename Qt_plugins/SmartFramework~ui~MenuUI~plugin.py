...
icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "MenuUI.png")
if os.path.exists(icon_path):
    MenuUI.__icon__ = QtGui.QIcon(icon_path)
else:
    MenuUI.__icon__ = QtGui.QIcon()


class MenuUIPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(MenuUIPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.ui.MenuUI.MenuUI
        SmartFramework.ui.MenuUI.MenuUI = MenuUI
        instance = MenuUI(parent=parent)
        SmartFramework.ui.MenuUI.MenuUI = old_class
        return instance
    ...
    def icon(self):
        return MenuUI.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return MenuUI.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.ui.MenuUI"
