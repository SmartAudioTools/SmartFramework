...
icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "Receive.png")
if os.path.exists(icon_path):
    Receive.__icon__ = QtGui.QIcon(icon_path)
else:
    Receive.__icon__ = QtGui.QIcon()


class ReceivePlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(ReceivePlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.sync.Receive.Receive
        SmartFramework.sync.Receive.Receive = Receive
        instance = Receive(parent=parent)
        SmartFramework.sync.Receive.Receive = old_class
        return instance
    ...
    def icon(self):
        return Receive.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return Receive.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.sync.Receive"
