...
icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "VideoBuffer.png")
if os.path.exists(icon_path):
    VideoBuffer.__icon__ = QtGui.QIcon(icon_path)
else:
    VideoBuffer.__icon__ = QtGui.QIcon()


class VideoBufferPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(VideoBufferPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.video.VideoBuffer.VideoBuffer
        SmartFramework.video.VideoBuffer.VideoBuffer = VideoBuffer
        instance = VideoBuffer(parent=parent)
        SmartFramework.video.VideoBuffer.VideoBuffer = old_class
        return instance
    ...
    def icon(self):
        return VideoBuffer.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return VideoBuffer.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.video.VideoBuffer"
