...
icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "QtTimer.png")
if os.path.exists(icon_path):
    QtTimer.__icon__ = QtGui.QIcon(icon_path)
else:
    QtTimer.__icon__ = QtGui.QIcon()


class QtTimerPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(QtTimerPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.time.QtTimer.QtTimer
        SmartFramework.time.QtTimer.QtTimer = QtTimer
        instance = QtTimer(parent=parent)
        SmartFramework.time.QtTimer.QtTimer = old_class
        return instance
    ...
    def icon(self):
        return QtTimer.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return QtTimer.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.time.QtTimer"
