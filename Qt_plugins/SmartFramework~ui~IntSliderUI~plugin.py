...
icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "IntSliderUI.png")
if os.path.exists(icon_path):
    IntSliderUI.__icon__ = QtGui.QIcon(icon_path)
else:
    IntSliderUI.__icon__ = QtGui.QIcon()


class IntSliderUIPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(IntSliderUIPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.ui.IntSliderUI.IntSliderUI
        SmartFramework.ui.IntSliderUI.IntSliderUI = IntSliderUI
        instance = IntSliderUI(parent=parent)
        SmartFramework.ui.IntSliderUI.IntSliderUI = old_class
        return instance
    ...
    def icon(self):
        return IntSliderUI.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return IntSliderUI.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.ui.IntSliderUI"
