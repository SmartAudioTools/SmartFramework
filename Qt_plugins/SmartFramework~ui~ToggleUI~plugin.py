...
icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "ToggleUI.png")
if os.path.exists(icon_path):
    ToggleUI.__icon__ = QtGui.QIcon(icon_path)
else:
    ToggleUI.__icon__ = QtGui.QIcon()


class ToggleUIPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(ToggleUIPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.ui.ToggleUI.ToggleUI
        SmartFramework.ui.ToggleUI.ToggleUI = ToggleUI
        instance = ToggleUI(parent=parent)
        SmartFramework.ui.ToggleUI.ToggleUI = old_class
        return instance
    ...
    def icon(self):
        return ToggleUI.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return ToggleUI.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.ui.ToggleUI"
