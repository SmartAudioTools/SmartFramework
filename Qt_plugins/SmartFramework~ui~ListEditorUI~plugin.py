...
icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "ListEditorUI.png")
if os.path.exists(icon_path):
    ListEditorUI.__icon__ = QtGui.QIcon(icon_path)
else:
    ListEditorUI.__icon__ = QtGui.QIcon()


class ListEditorUIPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(ListEditorUIPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.ui.ListEditorUI.ListEditorUI
        SmartFramework.ui.ListEditorUI.ListEditorUI = ListEditorUI
        instance = ListEditorUI(parent=parent)
        SmartFramework.ui.ListEditorUI.ListEditorUI = old_class
        return instance
    ...
    def icon(self):
        return ListEditorUI.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return ListEditorUI.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.ui.ListEditorUI"
