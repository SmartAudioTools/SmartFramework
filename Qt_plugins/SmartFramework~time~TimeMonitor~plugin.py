...
icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "TimeMonitor.png")
if os.path.exists(icon_path):
    TimeMonitor.__icon__ = QtGui.QIcon(icon_path)
else:
    TimeMonitor.__icon__ = QtGui.QIcon()


class TimeMonitorPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(TimeMonitorPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.time.TimeMonitor.TimeMonitor
        SmartFramework.time.TimeMonitor.TimeMonitor = TimeMonitor
        instance = TimeMonitor(parent=parent)
        SmartFramework.time.TimeMonitor.TimeMonitor = old_class
        return instance
    ...
    def icon(self):
        return TimeMonitor.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return TimeMonitor.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.time.TimeMonitor"
