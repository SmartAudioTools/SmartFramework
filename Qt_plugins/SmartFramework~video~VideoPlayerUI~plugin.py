...
icon_path = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "VideoPlayerUI.png"
)
if os.path.exists(icon_path):
    VideoPlayerUI.__icon__ = QtGui.QIcon(icon_path)
else:
    VideoPlayerUI.__icon__ = QtGui.QIcon()


class VideoPlayerUIPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(VideoPlayerUIPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.video.VideoPlayerUI.VideoPlayerUI
        SmartFramework.video.VideoPlayerUI.VideoPlayerUI = VideoPlayerUI
        instance = VideoPlayerUI(parent=parent)
        SmartFramework.video.VideoPlayerUI.VideoPlayerUI = old_class
        return instance
    ...
    def icon(self):
        return VideoPlayerUI.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return VideoPlayerUI.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.video.VideoPlayerUI"
