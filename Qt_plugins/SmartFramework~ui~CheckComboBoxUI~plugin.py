...
icon_path = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "CheckComboBoxUI.png"
)
if os.path.exists(icon_path):
    CheckComboBoxUI.__icon__ = QtGui.QIcon(icon_path)
else:
    CheckComboBoxUI.__icon__ = QtGui.QIcon()


class CheckComboBoxUIPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(CheckComboBoxUIPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.ui.CheckComboBoxUI.CheckComboBoxUI
        SmartFramework.ui.CheckComboBoxUI.CheckComboBoxUI = CheckComboBoxUI
        instance = CheckComboBoxUI(parent=parent)
        SmartFramework.ui.CheckComboBoxUI.CheckComboBoxUI = old_class
        return instance

    # This method returns the name of the custom widget class that is provided by this plugin.
    def name(self):
        return "CheckComboBoxUI"
    ...
    def icon(self):
        return CheckComboBoxUI.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return CheckComboBoxUI.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.ui.CheckComboBoxUI"
