...
icon_path = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "ImageShowWithCursorUI.png"
)
if os.path.exists(icon_path):
    ImageShowWithCursorUI.__icon__ = QtGui.QIcon(icon_path)
else:
    ImageShowWithCursorUI.__icon__ = QtGui.QIcon()


class ImageShowWithCursorUIPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(ImageShowWithCursorUIPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.image.ImageShowWithCursorUI.ImageShowWithCursorUI
        SmartFramework.image.ImageShowWithCursorUI.ImageShowWithCursorUI = (
            ImageShowWithCursorUI
        )
        instance = ImageShowWithCursorUI(parent=parent)
        SmartFramework.image.ImageShowWithCursorUI.ImageShowWithCursorUI = old_class
        return instance

    # This method returns the name of the custom widget class that is provided by this plugin.
    def name(self):
        return "ImageShowWithCursorUI"
    ...
    def icon(self):
        return ImageShowWithCursorUI.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return ImageShowWithCursorUI.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.image.ImageShowWithCursorUI"
