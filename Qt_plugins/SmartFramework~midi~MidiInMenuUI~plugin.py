import os
import SmartFramework.midi.MidiInMenuUI
...
MidiInMenuUI = transformClassForQtDesigner(
    SmartFramework.midi.MidiInMenuUI.MidiInMenuUI
)
icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "MidiInMenuUI.png")
if os.path.exists(icon_path):
    MidiInMenuUI.__icon__ = QtGui.QIcon(icon_path)
else:
    MidiInMenuUI.__icon__ = QtGui.QIcon()


class MidiInMenuUIPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    # The __init__() method is only used to set up the plugin and define its initialized variable.
    def __init__(self, parent=None):
        super(MidiInMenuUIPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        old_class = SmartFramework.midi.MidiInMenuUI.MidiInMenuUI
        SmartFramework.midi.MidiInMenuUI.MidiInMenuUI = MidiInMenuUI
        instance = MidiInMenuUI(parent=parent)
        SmartFramework.midi.MidiInMenuUI.MidiInMenuUI = old_class
        return instance
    ...
    def icon(self):
        return MidiInMenuUI.__icon__

    # Returns a short description of the custom widget for use in a tool tip.
    def toolTip(self):
        return MidiInMenuUI.__doc__
    ...
    def includeFile(self):
        return "SmartFramework.midi.MidiInMenuUI"
