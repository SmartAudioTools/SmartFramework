...
class Wacom(QtWidgets.QOpenGLWidget):
    def __init__(self, *args, **argDict):
        QtWidgets.QOpenGLWidget.__init__(self, *args, **argDict)
        ...
        # pour fillter les mouse move quand utilise le radia menu de la Wacom
    ...
    def event(self, event):
        ...
        if eventType == QtCore.QEvent.TabletMove:
            ...
            # if eventType not in (QtCore.QEvent.UpdateRequest, QtCore.QEvent.Paint):
            #    print("update request from wacom.py")
            # if eventType in eventNames:
            #    print("\n",eventNames[eventType])
            QtWidgets.QOpenGLWidget.event(self, event)
