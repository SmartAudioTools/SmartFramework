...
"""
    ...
    Description : qtpy custom combobox for selecting multiple options.
    Created : OCt 14, 2016
...
class CheckComboBoxUI(QtWidgets.QComboBox):

    checkedItems = QtCore.Signal(object)
    checkedItemsAndColors = QtCore.Signal(object)
    itemsStateAndColors = QtCore.Signal(object)
    # checkedItemIndexs  = QtCore.Signal(object)
    checkedCategorieItemsDict = QtCore.Signal(object)
    changeColor = QtCore.Signal(str, object)
    highlightedCategorieItems = QtCore.Signal(object, str)
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._separator = ","
        self._selectAllText = selectAllText
        self._changeColorEnable = changeColorEnable
        ...
        if isCategorie:
            ...
            if categorie:
                ...
                if categorieIndex == -1:
                    ...
                    QtWidgets.QComboBox.addItem(self, itemStr)
                else:
                    for searchIndex in range(categorieIndex + 1, self.count()):
                        if self._model.item(searchIndex, 0).isAutoTristate():
        ...
        for index in range(self.count()):
            ...
            itemList.append(
                ItemCategorieStateColor(
                    ...
                    isCategorie=item.isAutoTristate(),
                )
            )
    ...
    defaultText = QtCore.Property(str, getDefaultText, setDefaultText)
    ...
    selectAllText = QtCore.Property(str, getSelectAllText, setSelectAllText)
    ...
    separator = QtCore.Property(str, getSeparator, setSeparator)
    ...
    changeColorEnable = QtCore.Property(
    ...
    def resizeEvent(self, event):
        ...
        retour = QtWidgets.QComboBox.resizeEvent(self, event)
        self.updatePrintedText()
        return retour
